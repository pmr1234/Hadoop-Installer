...
1. **Pip Automation**: Ensures PySpark and NbFormat are natively tracked regardless of OS terminal paths.
...
2. Click **Get Data -> Text/CSV**, and natively path directly to your project's `output` folder:
   ```
   .../Spark_PowerBI_Experiment/output/daily_avg_fare.csv
   ```
